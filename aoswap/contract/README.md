...
This is a smart contract for AOS that allows the creation of continuous
...
AOSwap follows the line initiated by Bancor and Uniswap, but with some design improvements that we explain below.
...
In aoswap, each trading pair has an associated fee value that might be variable. The value of evotokens rises as they collect fees from exchange and addition of liquidity operations. The action of removing liquidity (selling evotokens) is free of charge.
...
A list of Claos commands to interact with this contract can be found at [Commands.md](Commands.md)
