...
void aoswap::transfer( const name& from, const name& to, const asset& quantity,
  const string& memo) {
...
void aoswap::sub_balance( const name& owner, const asset& value ) {
...
void aoswap::open( const name& owner, const symbol& symbol, const name& ram_payer )
{
...
void aoswap::close( const name& owner, const symbol& symbol )
{
   require_auth( owner );
   accounts acnts( get_self(), owner.value );
