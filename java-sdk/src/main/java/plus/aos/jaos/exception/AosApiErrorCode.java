...
public enum AosApiErrorCode implements ErrorCode {
    ...
    AOSIO_ASSERT_MESSAGE_ASSERTION_FAILURE(3050003),
    AOSIO_ASSERT_CODE_ASSERTION_FAILURE(3050004),
    ...
    private static final Map<Integer, AosApiErrorCode> idx = new HashMap<>();
    static {
        for (AosApiErrorCode errorCode : AosApiErrorCode.values()) {
    ...
    private AosApiErrorCode(int number) {
        this.number = number;
    }
    ...
    public static AosApiErrorCode get(Integer number) {
