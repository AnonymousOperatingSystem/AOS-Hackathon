package plus.aos.jaos.util;

import java.math.BigInteger;
import java.util.Objects;
import java.util.UUID;

import plus.aos.jaos.util.ecc.Ecdsa;
import plus.aos.jaos.util.ecc.Hex;
import plus.aos.jaos.util.ecc.Point;
import plus.aos.jaos.util.ecc.Ripemd160;
import plus.aos.jaos.util.ecc.Secp256k;
...
public class KeyUtil {
    public static final String address_prefix = "AOS";
